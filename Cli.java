...
public class Cli 
{
    ...
    //variables used in grid to create the grid 
    ...
    public void runtime() {
        ...
        try {// tries to do get an int from the user
            ...
            // user exception used if data entered is not valid then the program exception allows exist to the game 
        ...
        //checks if user input is within range of the grid coordinates
...
// the matrix board displays and prints out  
